...
teach = teacher.Teacher(scale=k,architecture=arc,W=W,b=b,use_database=True,reduce=1,database_dir=database_dir,softmax=False) 
...
def run_model(n,train_steps=50*1000,verbose=2,lr=0.001,anneal=True,plot=False,batch_size=32,epochs=1):
    ...
    model = student.Model([20,n,n,1],softmax=False,loss='power')
