...
We implement teacher/student training with a variety of network sizes and shapes.  We also tests performance of CNNs on image datasets. The reader is strongly encouraged to refer to the example.ipynb in the codebase. More details of the codebase can be found in Documentation.md.
